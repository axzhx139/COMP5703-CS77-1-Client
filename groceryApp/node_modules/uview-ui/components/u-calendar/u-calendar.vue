		...
		<view class="u-calendar">
			...
			<view class="u-calendar__bottom">
				<view class="u-calendar__bottom__choose">
					...
					<text v-if="endDate">to{{endDate}}</text>
				</view>
				<view class="u-calendar__bottom__btn">
					<u-button :type="btnType" style="background-color: #B0C07A;" shape="circle" size="default" @click="btnFix(false)">Confirm</u-button>
				</view>
			</view>
		</view>
	</u-popup>
